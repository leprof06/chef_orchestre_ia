...
def register_routes(app, orchestrator):
    ...
    def import_project_from_zip():
        ...
        ok, msg = import_project_from_zip (zip_path)
        return jsonify({"success": ok, "msg": msg})

    @app.route("/import/local", methods=["POST"])
    def import_project_from_local_folder():
        folder_path = request.form.get("folder_path")
        ok, msg = import_project_from_local_folder(folder_path)
        return jsonify({"success": ok, "msg": msg})
